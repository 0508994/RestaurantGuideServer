...
VALUES (1, "Biser", 1, NULL, 0, 0, "Yes", "Kafana", "Balkanska", 43.317759, 21.8954513, "+381618079418", "Koste Stamenkovica 1", "07:00:00", "24:00:00");

INSERT INTO PLACE (PlaceId, Name, CityId, PhotoURL, ReviewersNumber, GrossScore, LiveMusic, PlaceType, Coucine, Latitude, Longitude, PhoneNumber, Address, OpensAt, ClosesAt)
VALUES (2, "Galija", 1, NULL, 0, 0, "Yes", "Kafana", "Balkanska", 43.3180417, 21.8960932, "+381618079418", "Nikole Pasica 35", "10:00:00", "24:00:00");

INSERT INTO PLACE (PlaceId, Name, CityId, PhotoURL, ReviewersNumber, GrossScore, LiveMusic, PlaceType, Coucine, Latitude, Longitude, PhoneNumber, Address, OpensAt, ClosesAt)
VALUES (3, "Dušanov Konak", 1, NULL, 0, 0, "Yes", "Kafana", "Balkanska", 43.3180427, 21.9060469, "+381618079418", "Cara Dusana 124b", "00:00:00", "24:00:00");

INSERT INTO PLACE (PlaceId, Name, CityId, PhotoURL, ReviewersNumber, GrossScore, LiveMusic, PlaceType, Coucine, Latitude, Longitude, PhoneNumber, Address, OpensAt, ClosesAt)
VALUES (4, "Riva", 1, NULL, 0, 0, "No", "Restoran", "Italijanska", 43.3252738, 21.9015953, "+381618079418", "Kej 29. decembar 18b", "12:30:00", "24:00:00");

INSERT INTO PLACE (PlaceId, Name, CityId, PhotoURL, ReviewersNumber, GrossScore, LiveMusic, PlaceType, Coucine, Latitude, Longitude, PhoneNumber, Address, OpensAt, ClosesAt)
VALUES (5, "Nemir", 1, NULL, 0, 0, "No", "Pivnica", "Međunarodna", 43.3160043, 21.8910474, "+381649710262", "Obilićev Venac", "13:00:00", "24:00:00");

INSERT INTO PLACE (PlaceId, Name, CityId, PhotoURL, ReviewersNumber, GrossScore, LiveMusic, PlaceType, Coucine, Latitude, Longitude, PhoneNumber, Address, OpensAt, ClosesAt)
VALUES (6, "Ministarstvo", 1, NULL, 0, 0, "No", "Pivnica", "Međunarodna", 43.3198611, 21.9021157, "+38162393312", "Vojvode Vuka 12", "08:30:00", "01:30:00");

INSERT INTO PLACE (PlaceId, Name, CityId, PhotoURL, ReviewersNumber, GrossScore, LiveMusic, PlaceType, Coucine, Latitude, Longitude, PhoneNumber, Address, OpensAt, ClosesAt)
VALUES (7, "Berta", 1, NULL, 0, 0, "Yes", "Pivnica", "Međunarodna", 43.3180547, 21.9024848, "", "Dušanova 73", "09:00:00", "24:00:00");

INSERT INTO PLACE (PlaceId, Name, CityId, PhotoURL, ReviewersNumber, GrossScore, LiveMusic, PlaceType, Coucine, Latitude, Longitude, PhoneNumber, Address, OpensAt, ClosesAt)
VALUES (8, "Beer garden", 1, NULL, 0, 0, "Yes", "Pivnica", "Međunarodna", 43.3175997,21.8967537, "+3810654780857", "Dušanova 54,", "09:00:00", "02:30:00");
